...
<figure style="text-align:center">
  <img src="/assets/latentspace.webp" width="700">
...
<br>
![Autoencoder Graphical Representation](/assets/AE_image.webp){: width="450" style="display:block; margin:0 auto;"}
...
![Pairwise Scatter Matrix](/assets/pairwise_scatter.webp){: width="450" style="display:block; margin:0 auto;"}
...
<br>
![Latent Pearson Correlation Heatmap](/assets/corr_heatmap.webp){: width="450" style="display:block; margin:0 auto;"}
...
<br>
![Latent Space Trajectory Over Time (t-SNE)](/assets/latent_space_traj.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![SPY Anomaly Detection Graph on Test Period](/assets/spy_anomaly1.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![SPY vs VIX](/assets/spy_vix.png){: width="600" style="display:block; margin:0 auto;"}

<figcaption style="text-align: center;">ARR-SPY (MSE) vs VIX</figcaption><br>

![High ARR-SPY vs Low ARR-SPY](/assets/pred_power.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Lead-Lag Correlation Structure (ARR-SPY vs VIX)](/assets/lead_lag.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Bootstrap Distribution of Area Under the ROC Curve](/assets/bootstrap_dist.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Autoencoder’s Reconstruction Error on SPY returns over Time](/assets/recon_error.png){: width="600" style="display:block; margin:0 auto;"}
...
![Scatter plot of recon error vs latent magnitude](/assets/recon_error_latent_mag.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Latent dimension vs SPY returns](/assets/3dims.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Test Set SPY Cumulative Return by Active Regime](/assets/cumulative_return.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Line Graphs of SPY Sharpe Ratio, Win Rate, Volatility, and Cross-Correlation by Cluster](/assets/cluster_stability.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Autocorrelation for latent dimensions](/assets/autcorr.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Top Asset Mean Daily Returns by Regime on Test Period](/assets/structure.png){: width="600" style="display:block; margin:0 auto;"}
...
<br>
![Limit Order Book](/assets/LOB.png){: width="600" style="display:block; margin:0 auto;"}
