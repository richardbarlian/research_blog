...
categories: unsupervised-learning time-series quant-finance
...
<p style="text-align: center; font-size: 0.95em; color: #555;">
  Code available at <a href="https://github.com/richardbarlian/MarketAutoencoder" target="_blank" style="font-family: monospace;">Market Autoencoder Github</a>
</p>
...
I've uploaded all the code to Github, so you can replicate these findings: [Market Autoencoder](https://github.com/richardbarlian/MarketAutoencoder). All of the code has been released as well as the graphs generated by the scripts.
