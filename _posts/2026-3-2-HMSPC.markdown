...
<p style="text-align: center; font-size: 0.95em; color: #555;">
  ...
  <br>
  Preprint version now available at <a href="https://zenodo.org/records/20714492" target="_blank">Zenodo</a>!
</p>
...
Gradients are stopped through $\mu_{\text{obs},t_i}$ to prevent the uncertainty loss from distorting the mean prediction _(see [Appendix A.1](#stopping-gradients))_.
