...
<div style="display: flex; align-items: flex-start; gap: 2rem; margin-bottom: 1rem;">
  ...
  <div style="flex: 1;">
    ...
    <p>Neither does everyone know what I'm doing. People either think I'm Jimmy Neutron himself or a 16 year old who spends their entire day messing around prompting ChatGPT to do my homework (although that's not fully wrong either).</p>
...
<div style="display: flex; align-items: center; gap: 3rem; margin-top: 1rem;">
  <ul class="social-media-list" style="margin: 0;">
    <li>
